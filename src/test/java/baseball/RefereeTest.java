...
public class RefereeTest {
    ...
    @Test
    void construct(){
        Ball comBall = new Ball(new Position(1), new Number(1));
    ...
    void judge_strike(){
        Ball comBall = new Ball(new Position(1), new Number(1));
        Ball playerBall = new Ball(new Position(1), new Number(1));
        Referee referee = new Referee(comBall);
    ...
    void judge_ball(){
        Ball comBall = new Ball(new Position(1), new Number(1));
        Ball playerBall = new Ball(new Position(2), new Number(1));
        Referee referee = new Referee(comBall);
    ...
    void judge_nothing(){
        Ball comBall = new Ball(new Position(1), new Number(1));
        Ball playerBall = new Ball(new Position(2), new Number(2));
        Referee referee = new Referee(comBall);
